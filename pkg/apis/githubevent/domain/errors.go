...
/*
This file owns the sentinel errors for the GitHubEvent domain. Errors are
grouped by concern — structural identity, event semantics, Git context, actor
provenance, and lifecycle transitions. Callers use errors.Is to distinguish
error kinds without importing provider implementation details.
*/
package domain
