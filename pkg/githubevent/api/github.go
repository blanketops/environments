				...
				Template: &argoeventsv1alpha1.TriggerTemplate{
					...
					K8s: &argoeventsv1alpha1.StandardK8STrigger{
						...
						Parameters: []argoeventsv1alpha1.TriggerParameter{
							{Src: &argoeventsv1alpha1.TriggerParameterSource{DependencyName: "github-dep", DataKey: "headers.X-Github-Event"}, Dest: "spec.event_type"},
							{Src: &argoeventsv1alpha1.TriggerParameterSource{DependencyName: "github-dep", DataKey: "headers.X-Github-Delivery"}, Dest: "spec.event_id"},
							{Src: &argoeventsv1alpha1.TriggerParameterSource{DependencyName: "github-dep", DataKey: "body.repository.full_name"}, Dest: "spec.repository"},
							{Src: &argoeventsv1alpha1.TriggerParameterSource{DependencyName: "github-dep", DataKey: "body.ref"}, Dest: "spec.ref"},
							{Src: &argoeventsv1alpha1.TriggerParameterSource{DependencyName: "github-dep", DataKey: "body.after"}, Dest: "spec.commit_sha"},
