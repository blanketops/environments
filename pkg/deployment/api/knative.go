...
// func (r *KnativeReconciler) ReconcileKnative(ctx context.Context, env *environmentv1alpha1
...
// func envToKnativePodSpec(su environmentv1alpha1
.ServiceUnit) corev1.PodSpec {
