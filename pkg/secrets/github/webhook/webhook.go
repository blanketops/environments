...
/*
Package webhook reconciles the GitHub webhook secret — the ExternalSecret
backing the shared secret GitHub signs webhook deliveries with, scoped to a
GitHubEvent resource, and the teardown of both that ExternalSecret and its
