...
```go
import "github.com/blanketops/environments/pkg/secrets/github/hookurl"
```

Package hookurl reconciles the webhook hook\-url secret — a plain Secret \(no ESO involvement, since the URL is user\-declared on the GitRepository CR rather than sourced from an external store\) that exists only because Upjet's RepositoryWebhook consumes the URL via urlSecretRef.
...
## func [HookURLSecretName](<https://github.com/blanketops/environments/blob/main/pkg/secrets/github/hookurl/hookurl.go#L42>)
...
## type [HookURLSecretReconciler](<https://github.com/blanketops/environments/blob/main/pkg/secrets/github/hookurl/hookurl.go#L54-L58>)
...
### func [NewHookURLSecretReconciler](<https://github.com/blanketops/environments/blob/main/pkg/secrets/github/hookurl/hookurl.go#L60>)
...
### func \(\*HookURLSecretReconciler\) [Delete](<https://github.com/blanketops/environments/blob/main/pkg/secrets/github/hookurl/hookurl.go#L110>)
...
### func \(\*HookURLSecretReconciler\) [Reconcile](<https://github.com/blanketops/environments/blob/main/pkg/secrets/github/hookurl/hookurl.go#L64>)
