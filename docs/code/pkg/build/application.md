...
Write merges the provided conditions into the Build CR's status and persists. The caller is responsible for fetching the Build, setting Status.Contract, and determining which conditions to apply. This method only writes.
