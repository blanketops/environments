...
func TestToEnvironmentContract_NilSpec(t *testing.T) {
	var s *resolve.ResolvedEnvironmentSpec
	if got := ToEnvironmentContract(s); got != nil {
		t.Fatalf("expected nil, got %+v", got)
	}
}

func TestToEnvironmentContract_Minimal(t *testing.T) {
	s := &resolve.ResolvedEnvironmentSpec{ApplicationName: "app", EnvironmentType: "development"}
	out := ToEnvironmentContract(s)
...
func TestToEnvironmentContract_AllRefsPopulated(t *testing.T) {
	s := &resolve.ResolvedEnvironmentSpec{
		ApplicationName: "app",
		Build:           "b1",
		GitRepository:   "gr1",
		GitHubEvent:     "ev1",
		...
		Route:           "r1",
		Package:         "p1",
		Contract:        &resolve.ResolvedEnvironmentContract{SecretStoreProvider: "vault"},
	}
	out := ToEnvironmentContract(s)
...
func TestToEnvironmentContract_ContractPresentButEmptyProvider(t *testing.T) {
	s := &resolve.ResolvedEnvironmentSpec{
		ApplicationName: "app",
		Contract:        &resolve.ResolvedEnvironmentContract{},
	}
	out := ToEnvironmentContract(s)
	if out.Contract != nil {
