...
ResolveGitHubEvent function. The Adapter exists to satisfy interface-based injection
...
// Stateless — all resolution logic lives in ResolveGitHubEvent.
//
...
// Resolve delegates to ResolveGitHubEvent, returning the resolved GitHubEvent contract
