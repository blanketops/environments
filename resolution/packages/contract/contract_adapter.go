...
/*
Package contract implements the Package CR contract adapter — the one-way
projection from the resolved runtime spec (resolve.ResolvedPackageSpec) to
the protobuf contract type (contractv1.PackageSpec).
