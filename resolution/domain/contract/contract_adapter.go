...
/*
Package contract owns the proto projection for Domain — a one-way mapping
from the typed resolve.ResolvedDomainSpec to the canonical proto DomainSpec
...
func mapRouteRef(ref resolve.ResolvedDomainRouteRef) *networkscontractv1alpha1.DomainRouteRef {
...
func mapTLSStrategy(ts *resolve.TLSStrategy) *commonv1.DomainTLSStrategy {
	if ts == nil {
...
func mapMTLS(m resolve.ResolvedDomainMTLS) *networkscontractv1alpha1.DomainMTLS {
