...
func TestToGitRepositoryContract_NilSpec(t *testing.T) {
	var s *resolve.ResolvedGitRepositorySpec
	out, err := ToGitRepositoryContract(s)
	if err != nil {
...
func TestToGitRepositoryContract_UnknownProvider(t *testing.T) {
	s := &resolve.ResolvedGitRepositorySpec{Provider: "bogus", Repository: resolve.GitRepositoryRef{Owner: "o", Name: "n"}}
	_, err := ToGitRepositoryContract(s)
...
func TestToGitRepositoryContract_Minimal(t *testing.T) {
	s := &resolve.ResolvedGitRepositorySpec{Provider: "github", Repository: resolve.GitRepositoryRef{Owner: "o", Name: "n"}}
	out, err := ToGitRepositoryContract(s)
	if err != nil {
...
func TestToGitRepositoryContract_WebhooksProjected(t *testing.T) {
	s := &resolve.ResolvedGitRepositorySpec{
		Provider:   "github",
		Repository: resolve.GitRepositoryRef{Owner: "o", Name: "n"},
		Webhooks: []resolve.GitRepositoryWebhook{
...
func TestToGitRepositoryContract_WebhookEmptyEventsSkipped(t *testing.T) {
	s := &resolve.ResolvedGitRepositorySpec{
		Provider:   "github",
		Repository: resolve.GitRepositoryRef{Owner: "o", Name: "n"},
		Webhooks:   []resolve.GitRepositoryWebhook{{Events: []string{}}},
	}
	out, err := ToGitRepositoryContract(s)
	if err != nil {
		t.Fatalf("ToGitRepositoryContract: %v", err)
...
func TestToGitRepositoryContract_WebhookUnsupportedEvent(t *testing.T) {
	s := &resolve.ResolvedGitRepositorySpec{
		Provider:   "github",
		Repository: resolve.GitRepositoryRef{Owner: "o", Name: "n"},
		Webhooks:   []resolve.GitRepositoryWebhook{{Events: []string{"bogus"}}},
	}
	_, err := ToGitRepositoryContract(s)
