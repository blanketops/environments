...
/*
Package route — contract_adapter.go

This file owns the proto projection for Route — a one-way mapping from the
typed ResolvedRouteSpec to the canonical proto RouteSpec used for
...
import (
	commonv1 "github.com/ntlaletsi70/blanketops-environments-contract/blanketops/common/v1"
	networkscontractv1alpha1 "github.com/ntlaletsi70/blanketops-environments-contract/blanketops/networks/v1alpha1"
)
...
func mapRuntime(rt *Runtime) *commonv1.RouteRuntime {
	if rt == nil {
