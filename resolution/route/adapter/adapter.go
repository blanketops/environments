...
This file owns the Adapter — a thin struct wrapper around resolve.ResolveRoute.
...
// Adapter wraps the Route resolution function for interface-based injection.
// Stateless — all resolution logic lives in resolve.ResolveRoute.
//
...
// Resolve delegates to resolve.ResolveRoute, returning the resolved Route
...
func (a *Adapter) Resolve(ctx context.Context, route *networksv1alpha1.Route) (*resolve.ResolvedRoute, error) {
	return resolve.ResolveRoute(route)
}
