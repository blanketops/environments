...
```bash
go get github.com/ntlaletsi70/blanketops-environments@v0.6.0
```
...
If you are looking for the controller runtime, see the [BlanketOps Environments Controller](https://github.com/ntlaletsi70/blanketops-environments-controller) repository.
